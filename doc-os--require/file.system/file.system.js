define(['storage/storage'], function (Storage) {
    ...
    return {
        CustomFileSystem,
        MOVE: CustomFileSystem.MOVE,
        DELETE: CustomFileSystem.DELETE,
        CREATE_FILE: CustomFileSystem.CREATE_FILE,
        CREATE_DIRECTORY: CustomFileSystem.CREATE_DIRECTORY,
        ADD_TO_STORAGE: CustomFileSystem.ADD_TO_STORAGE,
        getInstance: () => {
            if (!instance) {
                instance = new CustomFileSystem()
            }
            return instance
        }
    }
